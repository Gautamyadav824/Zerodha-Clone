  ...
  return (
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        <h1 className="fs-3" style={{marginLeft:"35px"}}>To create a ticket, select a relavent topic. </h1>
        ...
        <div className="col-4 p-5 mt-2 ">
          <h4 className="">
            <i class="fa-solid fa-circle-left"></i>Kite
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            IPO
          </a>
        ...
        <div className="col-4 p-5 mt-2 ">
          <h4 className="">
            <i class="fa-brands fa-searchengin"></i>Console
          </h4>
          <a href="" style={{ textDecoration: "none", lineHeight: "2.5" }}>
            Protfolio
          </a>
