      ...
      <div className=" row  g-5 d-flex algin-items-center">
        ...
        <div className="col-6 px-5">
          <form onSubmit={onSubmitHandler}>
            {state === 'Sign up'? <h2 className="mb-2">Signup now</h2> :<h2 className="mb-2">Login</h2>}

            <p className="fs-5 text-muted mb-4">
              Or track your existing application
            </p>

            {state === 'Sign up' && (<div className="input-group w-50 mb-3">
            ...
            <div className="input-group w-50 mb-3"> 
                ...
                <input type="email" placeholder="Enter your email" onChange={e =>setEmail(e.target.value)} value={email} required className="form-control shadow-none"/>
            </div>
             <div className="input-group w-50 mb-3"> 
                <span className="input-group-text  bg-white">
                    <img src={assets.lock_icon} alt="password"/>
                </span>
                <input type="password" placeholder="Password" onChange={e =>setPassword(e.target.value)} value={password} required className="form-control shadow-none"/>
            </div>
          ...
          {state !=='Login' && ( <p className="small m-3 ms-4">If you have an existing account? <a className="text-blue-500 hover:text-blue-700 text-lg hover:underline font-small" onClick={()=>{setState('Login')}} href="#" >Login</a></p>)} 
            ...
            <a className="text-decoration-none small d-flex  align-items-left ms-5 ps-4 mt-4" href="#">Forgotten password?</a>
